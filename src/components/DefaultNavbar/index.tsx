...
function DefaultNavbar({
  ...
  const [dropdownName, setDropdownName]: any = useState("");
  const [nestedDropdown, setNestedDropdown]: any = useState("");
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Cryptography Asset Community Lab
            </MKTypography>
            <MKTypography
              fontWeight="bold"
              color={ light ? "white" : "dark" }
...
DefaultNavbar.defaultProps = {
  brand: "Cryptography Asset Community Lab",
  transparent: false,
  light: false,
  action: false,
  sticky: false,
